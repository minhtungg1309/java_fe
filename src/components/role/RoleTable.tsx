          ...
          <tbody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
            {roles.map((role, idx) => (
              <tr key={role.name} className="hover:bg-gray-50">
                ...
                <td className="px-5 py-4 font-medium text-gray-800 text-sm dark:text-white/90">
                  {role.name}
                </td>
                <td className="px-5 py-4 text-gray-500 text-sm dark:text-gray-400">
                  {role.description}
                </td>
            ...
            {roles.length === 0 && (
              <tr>
                <td
                  colSpan={5}
                  className="py-4 text-gray-400 text-center text-sm"
                >
