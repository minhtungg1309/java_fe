        ...
        <table className="min-w-full bg-white">
          <thead className="border-b border-gray-100 dark:border-white/[0.05]">
            <tr className="bg-gray-50">
              ...
              <th className="px-5 py-3 font-medium text-gray-500 text-start text-xs dark:text-gray-400">Tên quyền</th>
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
            {permissions.map((permission, idx) => (
              <tr key={permission.name} className="hover:bg-gray-50">
                ...
                <td className="px-5 py-4 font-medium text-gray-800 text-sm dark:text-white/90">{permission.name}</td>
                <td className="px-5 py-4 text-gray-500 text-sm dark:text-gray-400">{permission.description}</td>
            ...
            {permissions.length === 0 && (
              <tr>
                <td colSpan={4} className="py-4 text-gray-400 text-center text-sm">
                  Không có quyền nào.
                </td>
              </tr>
            )}
